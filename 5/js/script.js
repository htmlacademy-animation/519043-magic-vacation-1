...
/*!*****************************************!*\
  !*** ./source/js/modules/animations.js ***!
  \*****************************************/
/*! exports provided: default, AccentTypographyBuild */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class FullPageScroll {
  ...
  fadeInHistory() {
    const animationHistory = new _animations_js__WEBPACK_IMPORTED_MODULE_1__["AccentTypographyBuild"](`.js-history`, 400, `active`, `transform`);
    setTimeout(() => {
  ...
  fadeInPrizes() {
    const animationPrizes = new _animations_js__WEBPACK_IMPORTED_MODULE_1__["AccentTypographyBuild"](`.js-prizes`, 400, `active`, `transform`);
    setTimeout(() => {
  ...
  fadeInRules() {
    const animationRules = new _animations_js__WEBPACK_IMPORTED_MODULE_1__["AccentTypographyBuild"](`.js-rules`, 400, `active`, `transform`);
    setTimeout(() => {
  ...
  fadeInGame() {
    const animationGame = new _animations_js__WEBPACK_IMPORTED_MODULE_1__["AccentTypographyBuild"](`.js-game`, 400, `active`, `transform`);
    setTimeout(() => {
